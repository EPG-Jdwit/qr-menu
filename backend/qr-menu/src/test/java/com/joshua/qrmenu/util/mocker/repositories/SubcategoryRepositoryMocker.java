...
public class SubcategoryRepositoryMocker {
    ...
    public static SubcategoryRepository init() {
        ...
        doAnswer(args -> {
            ...
            Long subcategoryId = args.getArgument(1);
            Optional<SubcategoryEntity> optionalSubcategoryEntity = subcategoryRepository.findById(categoryId, subcategoryId);
            ...
            return null;
        }).when(subcategoryRepository).deleteById(nullable(Long.class), nullable(Long.class));
